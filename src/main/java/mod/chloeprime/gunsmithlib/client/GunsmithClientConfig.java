...
public class GunsmithClientConfig {
     ...
     * @since 6.2.0
     */
    public static final ForgeConfigSpec.BooleanValue HINT_ARCANA_INSTALLATION = BUILDER
            .comment("""
     ...
     * @since 6.2.0
     */
    public static final ForgeConfigSpec.EnumValue<AmmoTypeHudMode> HUD_AMMO_TYPE_NAME_OPTION = BUILDER
            .comment("""
     ...
     * @since 6.2.0
     */
    public static final ForgeConfigSpec.EnumValue<AmmoTypeHudMode> HUD_AMMO_TYPE_ICON_OPTION = BUILDER
            .comment("""
