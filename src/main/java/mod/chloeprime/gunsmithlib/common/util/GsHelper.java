...
public class GsHelper {
    ...
    public static ResourceLocation getAmmoId(GunInfo gunInfo) {
        ...
        var arcanaAmmoId = Optional.ofNullable(gunInfo.gunStack().getTag())
    ...
    public static Optional<GunInfo> gunInfoFromBullet(Entity bullet) {
        ...
        if (owner == null) {
            return bullet instanceof EntityKineticBullet ekb
                    ? Gunsmith.getGunInfo(Gunsmith.createGunItemFromId(ekb.getGunId()))
                    : Optional.empty();
        }
        ...
        return Gunsmith.getGunInfo(owner.getMainHandItem())
                ...
                .or(() -> Gunsmith.getGunInfo(Gunsmith.createGunItemFromId(ekb.getGunId())));
    }
